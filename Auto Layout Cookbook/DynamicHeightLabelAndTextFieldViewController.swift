...
class DynamicHeightLabelAndTextFieldViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        timer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(changeFontSizeTimerDidFire(_:)), userInfo: nil, repeats: true)
    }
    ...
    @objc func changeFontSizeTimerDidFire(_ timer: Timer) {
        ...
        nameLabel.font = usingLargeFont ? .systemFont(ofSize: 36.0) : .systemFont(ofSize: 17.0)
    }
}
